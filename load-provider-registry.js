...
var PROVIDERS = [
  ...
  // ── Browser Editing Primitives ───────────────────────────────────────────
  {
    ...
    name: 'FFmpeg.wasm',
    category: 'editing',
    capabilities: ['transcode', 'mux', 'trim', 'scale', 'fps', 'gif', 'compress', 'subtitles', 'export-mp4', 'export-webm'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
  ...
  // ── Timeline / Composition ────────────────────────────────────────────────
  {
    ...
    name: 'Remotion',
    category: 'editing',
    capabilities: ['composition', 'timeline', 'export-mp4'],
    accessType: 'local',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — React/Node rendering engine',
    licenseRisk: 'low',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'future-optional',
    labels: ['Free', 'Open Source', 'Local', 'Future Optional', 'Integration Required']
  },
  {
    providerId: 'fabricjs',
    name: 'Fabric.js',
    category: 'editing',
    capabilities: ['composition', 'canvas', 'overlay'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — HTML5 canvas library',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'future-optional',
    labels: ['Free', 'Open Source', 'Local', 'Future Optional']
  },
  {
    providerId: 'gsap',
    name: 'GSAP',
    ...
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — JS animation engine',
    licenseRisk: 'low',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'future-optional',
    labels: ['Free', 'Open Source', 'Local', 'Future Optional', 'License Check']
  },
  {
    providerId: 'lottiefiles',
    name: 'LottieFiles',
    category: 'editing',
    capabilities: ['animation', 'sticker', 'overlay'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Lottie JSON renders locally; public library requests go to lottiefiles.com',
    licenseRisk: 'low',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'future-optional',
  ...
  // ── Background Removal ────────────────────────────────────────────────────
  {
    providerId: 'mediapipe-segment',
    name: 'MediaPipe Selfie Segmentation',
    category: 'editing',
    capabilities: ['bg-removal', 'segmentation'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — runs in browser via WASM',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'future-optional',
  ...
  // ── Audio Processing ──────────────────────────────────────────────────────
  {
    ...
    name: 'Tone.js',
    category: 'audio',
    capabilities: ['sfx', 'synthesis', 'audio-processing'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — Web Audio API',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'future-optional',
  ...
  },
  {
    ...
    category: 'audio',
    capabilities: ['record', 'voice'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — stays on device',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'Local', 'No Key']
  },
  // ── Music Sources (Creative Commons / free) ───────────────────────────────
  {
    ...
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: 'https://pixabay.com/api/music/',
    privacyLabel: 'Search requests sent to pixabay.com',
    licenseRisk: 'low',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'No Key', 'CC / Royalty-Free']
  },
  {
    providerId: 'freemusicarchive',
    ...
    privacyLabel: 'Search requests sent to freemusicarchive.org',
    licenseRisk: 'low',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'unconfigured',
    labels: ['Free', 'API Key Needed', 'CC Licensed']
  },
  {
    providerId: 'ccmixter',
    name: 'ccMixter',
    ...
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: 'https://ccmixter.org/api/',
    privacyLabel: 'Search requests sent to ccmixter.org',
    licenseRisk: 'low',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'No Key', 'CC Licensed']
  },
  // ── Sound FX Sources ──────────────────────────────────────────────────────
  {
    ...
    privacyLabel: 'Search requests sent to freesound.org',
    licenseRisk: 'low',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'unconfigured',
  ...
  },
  {
    ...
    privacyLabel: 'Links to zapsplat.com for manual download',
    licenseRisk: 'low',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'No Key', 'License Check']
  },
  {
    ...
    privacyLabel: 'Links to mixkit.co for manual download',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'No Key', 'Free Commercial Use']
  },
  // ── Fonts ─────────────────────────────────────────────────────────────────
  {
    ...
    name: 'Google Fonts',
    category: 'typography',
    capabilities: ['font-load', 'font-preview'],
    accessType: 'free-web',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: 'https://fonts.googleapis.com',
    privacyLabel: 'Font files served from fonts.googleapis.com',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'No Key', 'OFL Licensed']
  },
  {
    ...
    privacyLabel: 'Privacy-first font CDN — no tracking',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
    labels: ['Free', 'No Key', 'Privacy-First', 'OFL Licensed']
  },
  // ── Subtitles / SRT ───────────────────────────────────────────────────────
  {
    providerId: 'srt-import',
    name: 'SRT Import',
    category: 'stt',
    capabilities: ['srt', 'subtitles'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — file parsed in browser',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
  ...
  // ── Export ────────────────────────────────────────────────────────────────
  {
    providerId: 'webm-export',
    name: 'WebM Export',
    category: 'editing',
    capabilities: ['export-webm', 'export'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Fully local — browser MediaRecorder API',
    licenseRisk: 'none',
    commercialUseStatus: 'allowed',
    fallbackEligible: false,
    status: 'active',
  ...
  // ── Project Storage ───────────────────────────────────────────────────────
  {
    ...
    category: 'storage',
    capabilities: ['save', 'load', 'asset-vault'],
    accessType: 'browser',
    requiresApiKey: false,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
  ...
  {
    providerId: 'supabase',
    name: 'Supabase (optional cloud save)',
    category: 'storage',
    capabilities: ['save', 'load', 'share'],
    accessType: 'free-web',
    requiresApiKey: true,
    requiresLocalEndpoint: false,
    defaultEndpoint: '',
    privacyLabel: 'Project data sent to Supabase — configure your own project',
    licenseRisk: 'none',
    commercialUseStatus: 'check',
    fallbackEligible: false,
    status: 'future-optional',
    labels: ['Free Tier', 'API Key Needed', 'Future Optional', 'Disabled by Default']
  }
];
...
var CAT_TITLES = {
  ...
  music: 'Music / SFX', video: 'Video', editing: 'Editing & Composition', llm: 'Local LLM / Router',
  typography: 'Fonts', storage: 'Project Storage'
};
