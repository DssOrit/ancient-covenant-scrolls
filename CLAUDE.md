...
13. **SOURCE INTEGRITY — LOCKED 2026-07-04 by user. Extended 2026-08-31
    ...
    critiques Rabbinic, Masoretic, Christian, or colonial-era
    manipulation of the texts — such content (NT Lookup, Suppressed,
    Contradictions, etc.) is explicitly permitted and valuable. The rule
    applies to sourcing only: never use those traditions as a foundation
    for anything built here.
